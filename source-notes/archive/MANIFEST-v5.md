...
# MANIFEST — FPQP Authoritative Source Set (v5)
...
| 181-200.pdf | pp. 157–176 | Module 4: Ch 4.2 rest (157–160: Coverages C/D, additional coverages, Section II E/F, Chapter 4.2 Review), Ch 4.3 Auto & Umbrella (161–168), Summary (169), Module 4 Review Answers (170–172); Module 5: cover (173), Introduction/LO table (174), Ch 5.1 Life Insurance start (175–176: Group Life, Term Life) |
...
| fpqp-module-04-insurance-basics-property-v3.md | Module 4 (book pp. 135–172, FULL module) | complete — supersedes v2/v1 |
| fpqp-module-05-life-health-insurance-v1.md | Module 5 (pp. 173–176 so far; Ch 5.1 partial) | **partial** — resumes at p. 177 |
...
| 5 | Life & Health Insurance | 173–? (thru 176 so far) | 🟡 partial — Ch 5.1 started (Group Life, Term Life); rest of 5.1 + Ch 5.2–5.5 + review answers pending |
...
## Next up
- `201-220.pdf` (book pp. 177–196): continue Chapter 5.1 Life Insurance (permanent/whole life, universal & variable life, policy features/provisions [LO 5-2], amount-of-life-insurance calculations [LO 5-3]) and beyond → grow `fpqp-module-05-...` toward v2.

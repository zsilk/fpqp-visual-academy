...
# MANIFEST — FPQP Authoritative Source Set (v7)
...
| 141-160.pdf | pp. 117–136 | Module 3: Ch 3.2 review Qs 5–13, Ch 3.3, Summary, Review Answers (125–134); Module 4 cover + intro (135–136) |
| 161-180.pdf | pp. 137–156 | Module 4: Ch 4.1 full (137–154); Ch 4.2 start (155–156) |
| 181-200.pdf | pp. 157–176 | Module 4: Ch 4.2 rest, Ch 4.3, Summary, Review Answers (157–172); Module 5 cover + Ch 5.1 start (173–176) |
| 201-220.pdf | pp. 177–196 | Module 5: Ch 5.1 rest + Ch 5.2 full (177–195); Ch 5.3 Disability start (196) |
| 221-240.pdf | pp. 197–216 | Module 5: Ch 5.3 rest (197–201), Ch 5.4 LTC (202–205), Ch 5.5 Annuities (206–212), Summary (213), Review Answers Ch 5.1–5.4 (214–216) |
| 241-260.pdf | pp. 217–236 | Module 5: Review Answers Ch 5.5 (217–218); Module 6 cover (219), Intro/LO table (220), Ch 6.1 Asset Classes (221–236: cash/stock/bonds/real estate, thru start of Ch 6.1 Review) |
...
| fpqp-module-05-life-health-insurance-v3.md | Module 5 (book pp. 173–218, FULL module) | complete — supersedes v2/v1 |
| fpqp-module-06-investment-basics-strategies-v1.md | Module 6 (pp. 219–236 so far; Ch 6.1 partial) | **partial** — resumes at p. 237 |
...
| 6 | Investment Basics and Strategies | 219–? (thru 236 so far) | 🟡 partial — Ch 6.1 Asset Classes captured (cash/stock/bonds/real estate); Ch 6.2–6.4 + review answers pending |
...
## Next up
- `261-280.pdf` (book pp. 237–256): finish the Chapter 6.1 Review, then Chapter 6.2 Types and Measurements of Risk [LO 6-5, 6-6], Chapter 6.3 Mutual Funds [LO 6-7], Chapter 6.4 Investment Decisions [LO 6-8], the module summary, and the Module 6 Review Answers → grow `fpqp-module-06-...` toward v2.
...
## Page math (reference)
- book printed page = whole-file (scanner) page − 24. Example: 241-260.pdf page 1 = book p. 217.
